...
import { Building, Search, MapPin, Briefcase, Users, Star, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-jobconnect-navy py-10">
        <div className="container mx-auto px-6">
          <h1 className="text-3xl font-bold mb-4 text-white">Browse Companies</h1>
          <p className="text-gray-300 mb-6">Discover top employers and explore their open positions</p>
          ...
          <Tabs defaultValue="all" onValueChange={setCurrentTab}>
                      ...
                      <div className="flex">
                        ...
                        <div className="flex-grow">
                          ...
                          <div className="grid grid-cols-2 gap-y-2 text-sm mt-4">
                            ...
                            <div className="flex items-center">
                              <Users size={16} className="mr-2 text-jobconnect-teal" />
                              <span>{company.employeeCount} employees</span>
                            </div>
                            
                            <div className="flex items-center">
                              <Star size={16} className="mr-2 text-jobconnect-teal" />
                          ...
                          <div className="mt-4 flex justify-end">
                            <Link to={`/companies/${company.id}`}>
                              <Button variant="outline" className="text-jobconnect-navy border-jobconnect-teal hover:bg-jobconnect-teal hover:text-white">
            ...
            <TabsContent value="featured">
              ...
              {filteredCompanies.length === 0 && (
                <div className="text-center py-10">
                  <Building size={48} className="mx-auto text-gray-300 mb-4" />
                  <h3 className="text-xl font-semibold mb-2">No featured companies found</h3>
                  <p className="text-gray-600">
                    Try adjusting your search criteria or browse all companies
                  </p>
                </div>
